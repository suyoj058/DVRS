...
interface Props {
  onSelect: (role: "renter" | "lister") => void;
}
    ...
    <div className="min-h-screen bg-gray-900 text-white flex items-center justify-center px-4">
      <div className="bg-gray-800 rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
        ...
        <p className="text-gray-300 mb-8">
          Are you here to <span className="text-orange-500 font-semibold">rent a vehicle</span>, or would you like to <span className="text-orange-500 font-semibold">list your own</span>?
        </p>
